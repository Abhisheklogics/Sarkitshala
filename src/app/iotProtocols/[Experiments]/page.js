 ...
 function P1() {
    ...
    return (
      <div className="p-4 max-w-4xl mt-20 mx-auto">
        <h1 className="text-3xl font-bold mb-2">Implementation of AMQP on Raspberry Pi</h1>
        ...
        <section className="mb-6">
          ...
          <ul className="list-disc list-inside space-y-1">
            <li className="text-gray-800">Install RabbitMQ as the message broker on Raspberry Pi.</li>
            <li className="text-gray-800">Use Python and Pika library to publish and consume messages.</li>
            <li className="text-gray-800">Simulate sensor data using a Python script.</li>
          </ul>
        </section>
        ...
        <section className="mb-6">
          ...
          <ol className="list-decimal list-inside space-y-4">
            <li>
              <h3 className="font-semibold">Step 1: Install RabbitMQ on Raspberry Pi</h3>
            ...
            <li>
              <h3 className="font-semibold">Step 2: Install Pika Library for Python</h3>
              <ul className="bg-gray-100 p-2 rounded-md text-sm text-gray-800 mt-1 space-y-1">
                <li>pip install pika</li>
              </ul>
            </li>
            <li>
              <h3 className="font-semibold">Step 3: Create a Publisher Script on Raspberry Pi</h3>
              <p className="text-gray-700 mb-2">This script sends random temperature values as messages.</p>
  ...
  while True:
      ...
      time.sleep(5)  # Send data every 5 seconds`}
            ...
            <li>
              <h3 className="font-semibold">Step 4: Create a Subscriber Script to Read Data</h3>
              <p className="text-gray-700 mb-2">This script will run on another device (or the same Raspberry Pi) to receive and process messages.</p>
              <div className="bg-gray-900 text-white p-4 rounded-md text-sm">
                <pre>
                  {`import pika
  ...
  channel.start_consuming()`}
        ...
        <section>
          <h2 className="text-xl font-semibold mb-2">Future Research</h2>
          <ul className="list-disc list-inside space-y-1 text-gray-800">
  ...
  function P3() {
    return `
    <div>
      <h2>Implementation of LoRaWAN Communication on ESP32</h2>
      <h3>Objective:</h3>
      <p>To establish LoRaWAN communication using an ESP32 and an external LoRa module (e.g., SX1278). The ESP32 will send sensor data over long-range communication to a LoRaWAN gateway, which will forward the data to the cloud or server.</p>
      ...
      <ol>
        <li>
          <h4>Step 1: Install ESP32 and LoRa Library in Arduino IDE</h4>
          <p>Open Arduino IDE and install the necessary libraries for LoRa communication:</p>
          <ul>
            <li>Install the "ESP32" board from Boards Manager.</li>
        ...
        <li>
          <h4>Step 2: Wiring the LoRa Module to ESP32</h4>
          <p>Connect the LoRa module (SX1278 or similar) to the ESP32 as follows:</p>
          <ul>
        ...
        <li>
          <h4>Step 3: Write Code for LoRa Communication</h4>
          <p>This code sends random temperature and humidity data over LoRa:</p>
          <pre>
#include <SPI.h>
#include <LoRa.h>
...
void loop() {
  ...
  delay(5000);
        ...
        <li>
          <h4>Step 4: Configure the LoRaWAN Gateway</h4>
        ...
        <li>
          <h4>Step 5: Read Data from the LoRaWAN Server</h4>
      ...
      <p>Upload the LoRa code to the ESP32, connect the LoRa module to the ESP32, and verify if the data is transmitted over LoRa to the gateway. You can test using a LoRa gateway or a LoRaWAN network for long-range communication.</p>
