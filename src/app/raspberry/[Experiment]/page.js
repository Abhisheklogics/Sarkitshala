...
export async function generateMetadata({ params }) {
  ...
  const ExperimentName = await getData(`${process.env.DOMAIN}api/experiments/Res`, params.Experiment);
  ...
  return {
    title: `${ExperimentName.ExperimentName} - Raspberry Pi `,
    robots: {
      index: true,
      follow: true
    },
    ...
    keywords: `${ExperimentName.ExperimentName}, Raspberry Pi, led, Soil Moisture, IoT Projects, Embedded Systems, Electronics, Circuit Design, Smart Agriculture Servo Motor, DC Motor, Ultrasonic, DHT11`,
    ...
    twitter: {
      ...
      description: ExperimentName.overview,
      image: ExperimentName.image1 || 'https://sarkitshala.site/', 
    }
  };
}
    ...
    <>
      ...
      md:h-fit md:w-[790px] md:ml-[330px]  md:mt-28 2xl:ml-[400px] md:p-5 md:bg-white md:bg-cover md:rounded-xl md:leading-8 md:text-justify md:break-words md:text-wrap ">
         ...
         />
          ...
          <h2 className="md:text-2xl md:mt-10 text-2xl  font-bold mt-10">{data.overview}</h2>
          ...
          <div className="md:leading-10 ">
            <p className="md:mt-10 md:text-2xl mt-10 text-2xl font-bold">{data.Material}</p>
          ...
          <h2 className={data.ExperimentId === '8' ? "md:text-2xl md:mt-20 text-2xl mt-8" : "md:text-2xl font-bold md:mt-16 text-2xl mt-8"}>
            {data.pinDiagramInfo}
          </h2>
          ...
          <h2 className={data.ExperimentId === '8' ? "md:mt-10 md:text-2xl text-2xl mt-8  " : "md:mt-4 font-bold md:text-2xl text-2xl mt-10"}>
          ...
          <h1 className="md:text-2xl md:mt-6 font-bold text-2xl mt-8">Steps:</h1>
          <div className="md:leading-10">
          ...
          <h2 className="md:mt-4 md:text-2xl text-2xl font-bold mt-8">Code:</h2>
          <CodeBox num={data.ExperimentId} exNam='Raspberry' language={'c'} />
          
          <h3 className="md:text-2xl md:mt-4 text-2xl font-bold mt-8">Conclusion</h3>
