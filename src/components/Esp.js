...
export default function Esp({ data }) {
  ...
  {data.image1 && <section className="mb-6 bg-white p-6 rounded shadow-lg border border-black">
   <Image height={400} width={700} className="md:ml-2 md:mt-2"  src={data.image1} alt={`${data.ExperimentName}`} />
 </section>}
 ...
 {data.image2 && <section className="mb-6 bg-white p-6 rounded shadow-lg border border-black">
        <Image height={400} width={700} className="md:ml-4 md:mt-2"  src={data.image2} alt={`${data.ExperimentName}`} /> 
         </section>}
 ...
 {data.image3 && <section className="mb-6 bg-white p-6 rounded shadow-lg border border-black">
   <Image height={600} width={400} className="md:mt-20 md:ml-40 mt-8 rounded"  src={data.image3} alt={`${data.ExperimentName} - Pin Diagram`}/>
     </section>}
      {/* Title 5 - Wiring */}
...
{data.image4 && <section className="mb-6 bg-white p-6 rounded shadow-lg border border-black">
 <Image height={400} width={500} className="md:ml-24    mt-10"  src={data.image4} alt={`${data.ExperimentName} - Circuit Diagram`} />
 </section>}
