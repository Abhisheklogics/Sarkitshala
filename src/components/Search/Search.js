...
export default function Search() {
  ...
  return (
    <div className="max-w-md mx-auto md:mt-4  mt-4 md:w-[200px] ml-28 md:ml-[1140px] 2xl:ml-[1220px] md:h-4">
      ...
      <div className="relative">
        ...
        <input
          type="search"
          id="default-search"
          className="block md:w-full w-[240px] md:h-[10px] md:p-6 p-2 pl-10 pr-10 text-sm text-gray-900 border border-gray-300 rounded-lg  focus:ring-blue-500 focus:border-blue-500 bg-gray-100 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
