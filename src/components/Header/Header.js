          ...
          <div className="md:mt-[-12px] mt-[-5px] ml-4 items-center justify-between w-full text-gray-900 md:w-auto md:order-1" id="navbar-sticky">
            <ul className="flex ml-[-15px] font-bold text-xl md:relative md:left-[500px] p-3 md:p-0  md:space-x-8 rtl:space-x-reverse md:mt-2 md:border-0 md:bg-none overflow-x-auto whitespace-nowrap overscroll-x-contain flex-nowrap">
              <li className='hover:bg-orange-400 p-1 rounded'>
                <Link href="/" className="block py-2 px-3  text-gray-900 rounded md:bg-transparent hover:text-white md:p-0">Home</Link>
              </li>
              <li className='hover:bg-orange-400 p-1 rounded'>
                <Link href="/arduino" className="block py-2 px-3 text-gray-900 rounded md:hover:bg-transparent md:hover:text-white md:p-0">Arduino</Link>
              </li>
              <li className='hover:bg-orange-400 p-1 rounded'>
                <Link href="/raspberry" className="block py-2 px-2 text-gray-900 rounded md:hover:bg-transparent md:hover:text-white md:p-0">Raspberry Pi</Link>
              </li>
              <li className='hover:bg-orange-400 p-1 rounded'>
                <Link href="/esp" className="block py-2 px-3 text-gray-900 rounded md:hover:bg-transparent md:hover:text-white md:p-0">Esp32</Link>
              </li>
              <li className='hover:bg-orange-400 p-1 rounded '>
                <Link href="https://codeeditor-five.vercel.app/" className="block py-2 px-3 text-gray-900 rounded hover:bg-gray-100 md:hover:bg-transparent md:hover:text-white md:p-0">Compiler</Link>
              </li>
            </ul>
          </div>
        </div>
