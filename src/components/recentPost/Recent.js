...
const RecentPosts = (props) => {
 ...
 let arr=[
  ...
  return (
    <div className="h-[500px]  w-fit md:w-[360px] bg-white overflow-hidden md:h-[450px] 2xl:h-[520px] md:shadow-lg md:rounded-md mt-6 mx-auto md:absolute md:top-[85px] xl:right-[-10px] md:right-[10px]">
