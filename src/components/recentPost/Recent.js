...
const RecentPosts = (props) => {
 ...
 let arr=[
  ...
  return (
    <div className="h-[450px] w-fit md:w-[400px] bg-white overflow-hidden md:h-[500px] 2xl:h-[520px] md:shadow-lg md:rounded-md mt-6 mx-auto md:absolute md:top-[110px] md:right-[60px]">
